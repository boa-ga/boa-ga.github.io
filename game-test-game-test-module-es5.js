...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["game-test-game-test-module"], {
  ...
  /***/
  function srcAppGamesGameTestGameTestComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GameTestComponent", function () {
      return GameTestComponent;
    });
    /* harmony import */
    ...
    var _game_test_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./game-test.service */
    "./src/app/games/game-test/game-test.service.ts");
    /* harmony import */


    var _test_players_test_players_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./test-players/test-players.component */
    ...
    var _test_board_test_board_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./test-board/test-board.component */
    ...
    var GameTestComponent = /*#__PURE__*/function () {
      function GameTestComponent(route, socketService, gameTestService, chatService, userSettingsService) {
        _classCallCheck(this, GameTestComponent);
      ...
      _createClass(GameTestComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (params) {
            ...
            return _this.gameTestService.joinGame(_this.gameId);
          ...
          this.userSettingsService.userSettings$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.tearDown$)).subscribe(function (settings) {
            return _this.chatService.myName = settings.name;
          });
          this.socketService.listen(_boa_ga_api_interfaces__WEBPACK_IMPORTED_MODULE_2__["ChatSendMessageAction"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.tearDown$)).subscribe(function (action) {
            return _this.chatService.sendMessage(action.payload.from, action.payload.text);
          });
          this.chatService.myMessages$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.tearDown$)).subscribe(function (text) {
            var sendMessageAction = new _boa_ga_api_interfaces__WEBPACK_IMPORTED_MODULE_2__["ChatSendMessageAction"]({
              gameId: _this.gameId,
              from: _this.chatService.myName,
              text: text
            });

            _this.socketService.emit(sendMessageAction);
          });
        }
      }, {
        key: "ngOnDestroy",
    ...
    GameTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [["fxFlex", "250px"], ["fxFlex", "", "fxLayout", "column"], ["fxFlex", ""], ["fxFlex", "0 0 300px"]],
      template: function GameTestComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GameTestComponent, [{
        ...
        return [{
          ...
          type: _game_test_service__WEBPACK_IMPORTED_MODULE_8__["GameTestService"]
        }, {
  ...
  /***/
  function srcAppGamesGameTestGameTestModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GameTestModule", function () {
    ...
    var _game_test_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./game-test.component */
    "./src/app/games/game-test/game-test.component.ts");
    /* harmony import */


    var _game_test_routes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./game-test.routes */
    "./src/app/games/game-test/game-test.routes.ts");
    /* harmony import */


    var _game_test_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./game-test.service */
    "./src/app/games/game-test/game-test.service.ts");
    /* harmony import */


    var _test_board_test_board_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./test-board/test-board.component */
    "./src/app/games/game-test/test-board/test-board.component.ts");
    /* harmony import */


    var _test_players_test_players_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./test-players/test-players.component */
    "./src/app/games/game-test/test-players/test-players.component.ts");

    var GameTestModule = function GameTestModule() {
      _classCallCheck(this, GameTestModule);
    };

    GameTestModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: GameTestModule
    });
    GameTestModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function GameTestModule_Factory(t) {
        return new (t || GameTestModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](GameTestModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GameTestModule, [{
  ...
  /***/
  function srcAppGamesGameTestGameTestRoutesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "gameTestRoutes", function () {
      return gameTestRoutes;
    });
    /* harmony import */


    var _game_test_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./game-test.component */
    "./src/app/games/game-test/game-test.component.ts");
  ...
  /***/
  function srcAppGamesGameTestGameTestServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GameTestService", function () {
      return GameTestService;
    });
    /* harmony import */
    ...
    var GameTestService = /*#__PURE__*/function () {
      function GameTestService(httpClient, configurationService) {
        _classCallCheck(this, GameTestService);

        this.httpClient = httpClient;
        this.configurationService = configurationService;
        this.apiBaseUrl = "".concat(this.configurationService.configuration.apiUrl, "games/test");
      }

      _createClass(GameTestService, [{
        key: "joinGame",
    ...
    GameTestService.ɵfac = function GameTestService_Factory(t) {
      return new (t || GameTestService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_services_configuration_service__WEBPACK_IMPORTED_MODULE_2__["ConfigurationService"]));
    };

    GameTestService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: GameTestService,
      factory: GameTestService.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](GameTestService, [{
  ...
  /***/
  function srcAppGamesGameTestTestBoardTestBoardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TestBoardComponent", function () {
    ...
    var TestBoardComponent = function TestBoardComponent() {
      _classCallCheck(this, TestBoardComponent);
    };

    TestBoardComponent.ɵfac = function TestBoardComponent_Factory(t) {
      return new (t || TestBoardComponent)();
    };

    TestBoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: TestBoardComponent,
      selectors: [["bg-test-board"]],
      decls: 1,
      vars: 0,
      template: function TestBoardComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TestBoardComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppGamesGameTestTestPlayersTestPlayersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TestPlayersComponent", function () {
      return TestPlayersComponent;
    });
    /* harmony import */
    ...
    var TestPlayersComponent = function TestPlayersComponent() {
      _classCallCheck(this, TestPlayersComponent);
    };

    TestPlayersComponent.ɵfac = function TestPlayersComponent_Factory(t) {
      return new (t || TestPlayersComponent)();
    };

    TestPlayersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: TestPlayersComponent,
      selectors: [["bg-test-players"]],
      decls: 1,
      vars: 0,
      template: function TestPlayersComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TestPlayersComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
//# sourceMappingURL=game-test-game-test-module-es5.js.map